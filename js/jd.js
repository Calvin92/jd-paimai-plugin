...
var JDAuction = function() {
	this.bodyWrap     = $("body");
	this.originPrice  = $(".cost del").text();
...
$.extend(JDAuction.prototype,{
	...
	handleLimitPrice: function() {
		this.priceLimit = parseInt(/\d+/.exec(this.originPrice)*1*0.7,10) || "暂无报价";
	...
	autoAuction: function() {
		...
		var _this = this;
		this.autoFlag = true;
		this.handleTime = isNaN(parseInt($('#handle_time'),10)) ? 0 : parseInt($('#handle_time'),10);
